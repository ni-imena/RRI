...
public class RegionNames {
    ...
    public static String FRAME_1 = "f1";
    public static String FRAME_2 = "f2";
    public static String FRAME_3 = "f3";
    public static String FRAME_4 = "f4";
    public static String FRAME_5 = "f5";
